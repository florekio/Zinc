...
**89.7% [Test262](docs/TEST262.md) conformance (14,215 / 15,855 active tests)** | **90 tests** | **~22,500 lines of Rust** | **beats V8 on fibonacci, ackermann, and loop_sum**
...
**89.7%** of tested ECMAScript spec tests pass (14,215 / 15,855 active tests). See [TEST262.md](docs/TEST262.md).
...
- **90 tests** passing
- **89.7%** Test262 conformance (14,215 / 15,855 active tests)
