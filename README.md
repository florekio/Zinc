...
**86.7% [Test262](docs/TEST262.md) conformance (13,820 / 15,947 active tests)** | **90 tests** | **~22,500 lines of Rust** | **beats V8 on fibonacci, ackermann, and loop_sum**
...
**86.7%** of tested ECMAScript spec tests pass (13,820 / 15,947 active tests). See [TEST262.md](docs/TEST262.md).
...
- **90 tests** passing
- **86.7%** Test262 conformance (13,820 / 15,947 active tests)
